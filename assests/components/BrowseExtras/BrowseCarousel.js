...
//   const fixedCardHeight = 250; // Increase card height
//   const fixedCardWidth = Dimensions.get('window').width / 1.8; // Increase card width, decrease the denominator
//   const spacing = 1; // Spacing between restaurant cards
...
//         inputRange,
//         outputRange: [0.85, 1.1, 0.85], // Adjust the output range for a more pronounced effect
//         extrapolate: 'clamp',
//       });
...
//         inputRange,
//         outputRange: [20, -50, 20], // Adjust the output range for a more pronounced effect
//         extrapolate: 'clamp',
//       });
...
//         }}
//         onPress={() => onIconPress(item, index)}
//       >
...
//   itemWidth={fixedCardWidth + spacing} // Adjust the itemWidth to be the card width plus spacing
//   inactiveSlideScale={0.8}
//   onSnapToItem={(index) => setSelectedRestaurantIndex(index)}
//   swipeThreshold={50} // Adjust the swipe threshold as needed
//   swipeVelocityThreshold={1000} // Adjust the swipe velocity threshold as needed
// />
//       </View>
//     </View>
//   );
...
//     position: 'absolute',
//     bottom: 130, // Adjust the value as needed to move the cards above the bottom navigation bar
//     left: 0,
//     right: 0,
...
//   imageContainer: {
//     position: 'absolute',
//     top: -30, // Adjust this to prevent the image from being cut off
//     height: 80,
//     width: 80,
//     borderRadius: 50,
//     overflow: 'visible',
